...
const createConnectors = (config: ConnectorConfig) => ({
  injected: new InjectedConnector(),
  metamask: new MetaMaskConnector(),
  coinbase: new CoinbaseConnector(
    config.coinbase.appName,
    config.coinbase.appLogoUrl,
    config.coinbase.jsonRpcUrl,
    config.coinbase.chainId,
    config.coinbase.darkMode
  ),
  walletconnect: new WalletConnectConnector(
    config.walletconnect.projectId,
    config.walletconnect.chains
  ),
});
...
export const Web3Provider: React.FC<Web3ProviderProps> = ({
  ...
  const [connectors, setConnectors] = useState(() =>
    createConnectors(connectorConfig)
  );
...
export const Web3ProviderWrapper: React.FC<Web3ProviderWrapperProps> = ({
  ...
  <QueryClientProvider client={queryClient}>
    <Web3Provider connectorConfig={connectorConfig}>
